    ...
    return (
        <div>
            ...
            <select id="wd-publish-all"> 
                <option value="PUBLISH-ALL">Publish All</option></select> 
                    ...
                    <ul className="wd-lessons">
                        ...
                        <li className="wd-slides">
                            ...
                            <ul className="wd-content">
                                ...
                                <li className="wd-contnet-item">Creating a React Application</li>
                            </ul>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul className="wd-lessons">
                        ...
                        <li className="wd-slides">
                            ...
                            <ul className="wd-content">
                                ...
                                <li className="wd-contnet-item">Formatting content with Lists and Tables</li>
                            </ul>
                        </li>
                    </ul>
                </li>
