        ...
        <Container>
            ...
            <div id="wd-css-id-selectors">
                ...
                <p id="wd-id-selector-1">
                    Instead of changing the look and feel of alll the 
                    elements of the same name, e.g., P, we can refer
                    to a specific element by its ID
                </p>
                <p id="wd-id-selector-2">
                    Here is an other paragraph using a different and 
            ...
            <div id="wd-class-selectors">
                ...
                <p className="wd-class-selector">
                    ...
                    use an elements CLASS attribute
                </p>
                ...
                <div className="wd-selector-1">
                    ...
                    <div className="wd-selector-2">
                        ...
                        <p className="wd-selector-3">
                            ...
                            specfic styles depending on the document structure
                        </p>
                    </div>
                </div>
            </div>
